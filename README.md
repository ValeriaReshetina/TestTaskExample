...
## <img width="4%" title="Telegram" src="images/logo/telegram.png"> Telegram notifications using a bot
...
## <img width="4%" title="Selenoid" src="images/logo/selenoid.png"> Test running example in Selenoid
